...
\makeatletter% Ein kleiner Hack, da xltxtra sonst einen Fehler verursacht
  \let\TeX@logo@spacing\relax
\makeatother
...
In der DTK 3/2008 hat Markus Kohm berichtet, dass das große scharfe S ({\fontspec{Linux Libertine O}ẞ}) normiert wurde. Leider gibt es (noch) sehr wenige Schriften (z.\,B. die Linux Libertine), in denen dieses Zeichen vorhanden ist – aber schon lange vor dieser Meldung konnte es mit Neo direkt eingegeben werden.
